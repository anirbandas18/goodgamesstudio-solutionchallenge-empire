...
@Component
@Slf4j
public class UnitDto2EntityConverter implements ComparativePatchConverter<UnitDto, UnitEntity> {
    ...
    @Override
    public void compareAndMap(UnitDto dto, UnitEntity actualEntity) throws TOABBaseException {
        ...
        if(!fieldsToEscape.contains("name") && optName.isPresent()) {
            ...
            changeSW[i++] = true;
            log.debug("UnitDto.name is valid");
        }
